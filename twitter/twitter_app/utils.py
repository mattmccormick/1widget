...
CONSUMER_KEY = getattr(settings, 'CONSUMER_KEY', 'kLBf68AT8AH0gUgl0dluA')
CONSUMER_SECRET = getattr(settings, 'CONSUMER_SECRET', 'KRfYtPdsMTA3tsGbVU8xUZBENMYLZ05pFo3IRkkNSw')
